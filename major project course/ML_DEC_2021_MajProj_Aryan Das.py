...
* Keep You hand Close to Camera For Better Performance
* Press Q to close the web cam window.
* Hand range 30 - 130
* Volume  range by pycaw -65 - 0
* Camera is Set to the default system camera
...
while cam.isOpened() :
    ...
    #List to store landmarks and ids
    lmList = []
    ...
    if lmList != []:
        ...
        cv.putText(frame, f'{int(volpercent)}%' , (15,50), cv.FONT_HERSHEY_PLAIN , 2 , (255,255,255) , 1)
